            ...
            <div id="category" class="row mb-5 align-items-center">
                ...
                <div  class=" col-md-12 col-lg-6 text-left text-lg-right " data-aos="fade-up"
                    ...
                    <div style="margin-right: 70px">
                        <span class="recommend_orderBy clickPointer font_hans" name="searchRecommend_order"> 추천순 </span>
                        <span class="recommend_orderBy clickPointer font_hans" name="searchRating_order"> 평점순 </span>
                        <span class="recommend_orderBy clickPointer font_hans" name="searchReview_order"> 리뷰순 </span>
                    </div>
                </div>
            </div>
