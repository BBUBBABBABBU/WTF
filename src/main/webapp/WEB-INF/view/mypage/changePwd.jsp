            ...
            <div class="container">
                <div class="row no-gutters slider-text justify-content-center align-items-center">
                    <div class="col-md-8 ftco-animate">
                        <p class="breadcrumbs"><span class="mr-2"><a href="/mypage">마이 페이지 > </a></span>
                            <span>문의사항</span></p>
                ...
                <div class="row">
                    <form role="form" id="infoForm" action="/pwdChange">
                        <div class="form-group"><label for="currentPass">현재 비밀번호</label>
                            <input type="password" class="form-control" id="currentPass" value="${member.password}">
                        </div>
                        <div class="form-group"><label for="nextPass">변경할 비밀번호</label>
                            <input type="password" class="form-control" id="nextPass" value="" onfocusout="chkPW()">
                        </div>
