...
<%--&lt;%&ndash;                <%! HttpServletRequest request; %>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <%! HttpSession se = request.getSession(); %>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <%! MemberVO memberVO = (MemberVO) se.getAttribute("member"); %>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <% System.out.println("최종성공:" + memberVO.getEmail()); %>&ndash;%&gt;--%>
