...
# 최종 함수
def recommend_restaurant01(member_id):
    # DB 연결
    ...
    # member_id로 안가본 식당 리스트 구하기
    unate_list = get_unate_food(R_ori, member_id)

    #20개의 추천 리스트 구하기
    recom_list =recom_res_by_userid(ratings_pred_matrix, member_id, unate_list, top_n=20)
